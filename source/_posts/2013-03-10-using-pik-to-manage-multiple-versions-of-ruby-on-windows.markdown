...
versions.  `pik` is a third-party tool that can be used to switch
...
files with the Ruby installation (the default choice) - `pik` will
manage this setting:

![Ruby Installer](/images/rubyinstaller.png)
...
![Pik Installer](/images/pikinstaller.png)

You can verify that `pik` installed properly by running the
...
======================================
Use the `pik add` command to register your installed ruby
...
Use the `pik list` command to list all the ruby interpreters
registered with pik:
...
Set a default Ruby
==================
The `pik use` command will allow you to switch between your
...
![Ruby not found'](/images/rubynewcommand.png)

Either run the `pik default` command to load pik (and the
